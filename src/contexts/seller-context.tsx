...
const generateSampleSales = (): Sale[] => {
  ...
  for (let i = 0; i < 45; i++) {
    ...
    // Random number of sales per day (0-3)
    ...
    for (let j = 0; j < dailySales; j++) {
      ...
      for (let k = 0; k < numItems; k++) {
        ...
        // Generate a variant ID that would match the actual product variant structure
...
export function SellerProvider({ children }: { children: ReactNode }) {
  ...
  const [products, setProducts] = useState<ProductWithInventory[]>([
    ...
    },
    {
      ...
      variants: [
        // Blue variants with blue-specific images
        { 
          id: "v21-1", 
          color: "Blue", 
          size: "S", 
        ...
        // Black variants with black-specific images
        { 
          id: "v21-5", 
          color: "Black", 
          size: "S", 
        ...
        // Red variants with red-specific images
        { 
          id: "v21-9", 
          color: "Red", 
          size: "S", 
        ...
        // Green variants with green-specific images
        { 
          id: "v21-13", 
          color: "Green", 
          size: "S", 
        ...
        // White variants with white-specific images
        { 
          id: "v21-17", 
          color: "White", 
          size: "S", 
